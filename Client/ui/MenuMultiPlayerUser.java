...
public class MenuMultiPlayerUser extends Menu {
	...
	public static void init(Panel root) {
		if (instance == null) {
			...
			loginAccount =  new MenuString(root, "Login", new Font("TimesRoman", Font.BOLD, 30), MenuString.Side.CENTER, 400);
			loginAccount.setColor( Color.WHITE, Color.CYAN, Color.BLUE);
            widgets.add(loginAccount);

            createAccount =  new MenuString(root, "Crear cuenta", new Font("TimesRoman", Font.BOLD, 30), MenuString.Side.CENTER, 450);
			createAccount.setColor( Color.WHITE, Color.CYAN, Color.BLUE);
            widgets.add(createAccount);


            backButton =  new MenuString(root, "Atras", new Font("TimesRoman", Font.BOLD, 30), MenuString.Side.CENTER, 600);

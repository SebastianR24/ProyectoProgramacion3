...
public class MenuSetting extends Menu {
    ...
    public static void init(Panel root) {
        if (instance == null) {
			...
			widthBoard = new MenuEntry(root, "Ancho: ", "100", new Font("TimesRoman", Font.BOLD, 30),300, 400);
			widthBoard.setColor(Color.YELLOW, Color.WHITE, Color.CYAN, Color.BLUE);
			
			heightBoard = new MenuEntry(root, "Alto: ", "70", new Font("TimesRoman", Font.BOLD, 30),300, 450);

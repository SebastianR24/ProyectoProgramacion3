...
public class MenuMultiPlayerRoomOption extends Menu{
	...
	public static void init(Panel root) {
		if (instance == null) {
			...
			joinRoom = new MenuString(root, "Unirme a una sala", new Font("TimesRoman", Font.BOLD, 30),
					MenuString.Side.CENTER, 425);

			createRoom = new MenuString(root, "Crear Sala", new Font("TimesRoman", Font.BOLD, 30),
	...
	public static MenuMultiPlayerRoomOption getInstance() {
		if (instance == null) {
			throw new AssertionError("Debes hacer el llamado a la instancia primero");
		}

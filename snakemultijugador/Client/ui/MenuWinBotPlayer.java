...
public class MenuWinBotPlayer extends Menu {
	...
	public static void init(Panel root) {
		if (instance == null) {
			...
			title = new MenuString(root, "Has Ganado !", new Font("American Uncial", Font.BOLD, 75), MenuString.Side.CENTER);
			playAgain = new MenuString(root, "Volver a jugar", new Font("TimesRoman", Font.BOLD, 30), MenuString.Side.CENTER,
					500);
			exit = new MenuString(root, "Cerrar", new Font("TimesRoman", Font.BOLD, 30), MenuString.Side.CENTER, 550);
	...
	public static MenuWinBotPlayer getInstance() {
		if (instance == null) {
			throw new AssertionError("Tienes que llamar a init primero");
		}

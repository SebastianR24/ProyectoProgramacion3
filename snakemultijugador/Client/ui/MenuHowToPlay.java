...
public class MenuHowToPlay extends Menu {
    ...
    public static void init(Panel root) {
        if (instance == null) {
            ...
            info = new MenuString(root, "Para jugar debes elegir como lo haras, si tu solo, con bots o en multiplayer(Error). Te mueves utilizando las flechitas del teclado ", new Font("TimesRoman", Font.BOLD, 20),

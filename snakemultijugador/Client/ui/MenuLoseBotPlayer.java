...
public class MenuLoseBotPlayer extends Menu{
    ...
    public static void init(Panel root) {
		if (instance == null) {
			...
			title = new MenuString(root, "Has perdido!", new Font("TimesRoman", Font.BOLD, 75), MenuString.Side.CENTER);
			playAgain = new MenuString(root, "Volver a jugar", new Font("TimesRoman", Font.BOLD, 30), MenuString.Side.CENTER,450);

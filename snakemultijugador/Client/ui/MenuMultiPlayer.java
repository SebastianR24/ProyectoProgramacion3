...
public class MenuMultiPlayer extends Menu{
	...
	public static void init(Panel root) {
		if (instance == null) {
			...
			exitButton = new MenuString(root, "Cerrar", new Font("Arial", Font.BOLD, 30), 900, 50);
			scoreTitle = new MenuString(root, "Puntaje: 0", new Font("Arial", Font.BOLD, 30), MenuString.Side.CENTER, 100);
			infoRoom = new MenuString(root, "ID: ", new Font("Arial", Font.BOLD, 30), MenuString.Side.CENTER, 50);
	...
	public static MenuMultiPlayer getInstance() {
		if (instance == null) {
			throw new AssertionError("Debes iniciar primero");
		}
	...
	private int fromByteArray(byte[] bytes) {
		if (bytes == null || bytes.length < 4) {
			// Manejo de la situación donde el array de bytes es nulo o tiene longitud menor a 4
	...
	public void update() {
		...
		scoreTitle.setText("Puntaje: " + score);

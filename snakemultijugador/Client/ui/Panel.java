...
//ACA SE INICIALIZA TODO EL JUEGO
public class Panel extends JPanel implements ActionListener {
	...
	public static Panel getInstance() {
		...
		fpsInfo = new MenuString(instance, "0", new Font("TimesRoman", Font.BOLD, 15), MenuString.Side.L, MenuString.Side.L);
